...
public class CloudGraphActivity extends AppCompatActivity {
    ...
    public void renew_urls() {
        ...
        switch (radioGroup.getCheckedRadioButtonId()) {
            case R.id.ultra_red: id=1; break;
            case R.id.vis_color: id=2; break;
            case R.id.steam: id=3; break;
            default: id=0; break;
        }
    ...
    static class CG_URL_Handler {
        ...
        public ArrayList<String> generate(int count, int type) {
            switch (type) {
                case 1: url_pattern[1] = "/WXBL/SEVP_NSMC_WXBL_FY4A_EC012_ACHN_LNO_PY_"; break;
                case 2: url_pattern[1] = "/WXBL/medium/SEVP_NSMC_WXBL_FY4A_EC001_ACHN_LNO_PY_"; break;
                case 3: url_pattern[1] = "/WXBL/SEVP_NSMC_WXBL_FY4A_EC009_ACHN_LNO_PY_"; break;
                default: url_pattern[1] = "/WXBL/SEVP_NSMC_WXBL_FY4A_ETCC_ACHN_LNO_PY_"; break;
            }
